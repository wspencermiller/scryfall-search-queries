...
- **Delete:** Click ✕ on a query or folder to remove it.
- **Manage:** Click **Manage** in the popup footer to open a full-page editor in a new tab. There you can see all folders and queries in a table, edit or delete any query inline, rename or delete folders, and use Export/Import.
